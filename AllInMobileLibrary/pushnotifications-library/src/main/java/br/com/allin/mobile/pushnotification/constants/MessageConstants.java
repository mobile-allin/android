...
public class MessageConstants {
    ...
    public static String CREATE_TABLE = String.format("CREATE TABLE IF NOT EXISTS %s " +
                ...
                MessageConstants.TABLE_NAME,
                MessageConstants.DB_FIELD_ID, MessageConstants.DB_FIELD_ID_SEND,
                MessageConstants.DB_FIELD_SUBJECT, MessageConstants.DB_FIELD_DESCRIPTION,
                MessageConstants.DB_FIELD_ID_CAMPAIGN, MessageConstants.DB_FIELD_ID_LOGIN,
                MessageConstants.DB_FIELD_URL_SCHEME, MessageConstants.DB_FIELD_ACTION,
                MessageConstants.DB_FIELD_DATE_NOTIFICATION, MessageConstants.DB_FIELD_URL_TRANSACTIONAL,
                MessageConstants.DB_FIELD_URL_CAMPAIGN, MessageConstants.DB_FIELD_READ);
